...
{
    public class MvxTempleCompletionToSouthButtonBackgroundConverter : MvxValueConverter<bool, Drawable>
    {
        protected override Drawable Convert(bool value, Type targetType, object parameter, CultureInfo culture)
        {
            return value
                ? Application.Context.Resources.GetDrawable(Resource.Drawable.lr_yellow_green_gradient, null)
