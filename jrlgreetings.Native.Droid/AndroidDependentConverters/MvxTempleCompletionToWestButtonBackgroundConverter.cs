...
{
    public class MvxTempleCompletionToWestButtonBackgroundConverter : MvxValueConverter<bool, Drawable>
    {
        protected override Drawable Convert(bool value, Type targetType, object parameter, CultureInfo culture)
        {
            return value
                ? Application.Context.Resources.GetDrawable(Resource.Drawable.tb_red_yellow_gradient, null)
